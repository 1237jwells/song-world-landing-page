...
import cartoonSongWorldContact from '../assets/song-world/transparent/AI-GEN/collaborate_icon_square.png';
const ContactUs = () => {
    ...
    <div className="bg-slate-50 dark:bg-gray-800/30 text-songworld-light-text dark:text-songworld-dark-text py-16 sm:py-24">
      ...
      >
        <div className="flex justify-center mb-12">
          <img src={cartoonSongWorldContact.src} alt="cartoonSongWorld" className="h-16 w-16 mr-4" />
